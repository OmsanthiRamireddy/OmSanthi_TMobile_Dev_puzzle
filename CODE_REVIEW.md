=> in reading-list reducer some reducers are not added (failedRemoveFromReadingList, confirmedRemoveFromReadingList, failedAddToReadingList, confirmedAddToReadingList) -- done.
